...
export function createRestaurant({ name, genres = [] }) {
  const id = crypto.randomUUID();

  // AQUÍ YA NO HAY LÍMITE DE 40
  // toma TODAS las canciones de los géneros seleccionados
  const songs = buildSongsFromGenres({ genres });
